...
import { PRODUCTS } from "../../pages/DressUpHub/products";
import { Product } from "./product-config";
import { Link } from "react-router-dom";
import { ShoppingCart } from "phosphor-react";
import "./DressUpHub.css";
import ShopHeaderImg from './images/shop1.png';


export const DressUpHub = () => {
  return (
    <div className="dressUpHub">
...
<div className="Shop-Header section-padding" id="home">
    <div className="Shop-Header-content">
      <h1 className="gradient__text">DRESS UP HUB</h1>
          ...
          <div class="center box">
            ...
            <div class="content">
              <div class="place">
                ...
                <span class="text">Braamfontein, Johannesburg, South Africa</span>
              </div>
              <div class="phone">
              ...
              <div class="email">
                ...
                <span class="text">dressuphub@gmail.com</span>
              </div>
            </div>
          </div>
